...
/** BcUpgradePlugin */
class BcUpgradePlugin: FlutterPlugin, ActivityAware, MethodCallHandler,EventChannel.StreamHandler{
  ...
  override fun onAttachedToEngine(@NonNull flutterPluginBinding: FlutterPlugin.FlutterPluginBinding) {
    channel = MethodChannel(flutterPluginBinding.binaryMessenger, "bc_app_upgrade")
    channel.setMethodCallHandler(this)
    val eventChannel =
      EventChannel(flutterPluginBinding.binaryMessenger, "bc_app_upgrade_listener")
