package com.example.bc_upgrade.appupdate.manager
...
import com.example.bc_upgrade.R
import com.example.bc_upgrade.appupdate.base.BaseHttpDownloadManager
import com.example.bc_upgrade.appupdate.config.Constant
import com.example.bc_upgrade.appupdate.listener.LifecycleCallbacksAdapter
import com.example.bc_upgrade.appupdate.listener.OnButtonClickListener
import com.example.bc_upgrade.appupdate.listener.OnDownloadListener
import com.example.bc_upgrade.appupdate.service.DownloadService
import com.example.bc_upgrade.appupdate.util.ApkUtil
import com.example.bc_upgrade.appupdate.util.LogUtil
import com.example.bc_upgrade.appupdate.view.UpdateDialogActivity
...
class DownloadManager private constructor(builder: Builder) : Serializable {
    ...
    internal var isForeground: Boolean
