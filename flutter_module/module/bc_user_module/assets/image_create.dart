...
Future<void> main() async {
  ...
  await for (final FileSystemEntity entity in entityList) {
    if (entity.path.endsWith('.png') &&
      ...
      result += "\tstatic const ${toUpperCase(name)} = 'packages/bc_user_module/${entity.path}';\n";
    }
  }
  result += '}';
  File.fromUri(
    Uri.parse('${Uri.base}lib/common/util/bc_image_path.dart'),
