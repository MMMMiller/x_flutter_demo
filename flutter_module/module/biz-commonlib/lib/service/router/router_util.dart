...
import 'package:common_lib/service/router/bundle.dart';
export 'package:common_lib/service/router/bundle.dart';
import 'package:common_lib/service/router/routes.dart';
...
class RouterUtil {
  ...
  void pop([Bundle? bundle]) {
    Navigator.of(navGK.currentContext!).pop(bundle);
  }

  ///返回页面直到路由为[untilRoute]时停止
  void popUntil(String untilRoute) {
    Navigator.of(navGK.currentContext!)
