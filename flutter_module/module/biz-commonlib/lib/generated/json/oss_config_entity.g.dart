...
OssConfigEntity $OssConfigEntityFromJson(Map<String, dynamic> json) {
  ...
  final String? udcMaterialId = jsonConvert.convert<String>(
      json['udcMaterialId']);
...
extension OssConfigEntityExtension on OssConfigEntity {
  OssConfigEntity copyWith({
    String? accessId,
    String? bucketName,
    String? callback,
    String? cdnHost,
    ...
    return OssConfigEntity()
      ...
      ..udcMaterialId = udcMaterialId ?? this.udcMaterialId;
  }
}