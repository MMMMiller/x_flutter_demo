...
import 'package:common_lib/components/container/bc_bottom_navigation_bar_item.dart';
import 'package:common_lib/components/index.dart';
import 'package:common_lib/index.dart';
import 'package:flutter/material.dart';
import 'package:vector_math/vector_math_64.dart' show Vector3;

class BcBottomNavigationBar extends StatefulWidget {
  ...
  BcBottomNavigationBar({
    ...
    this.landscapeLayout,
        ...
        assert(
          items.every((BcBottomNavigationBarItem item) => item.label != null),
  ...
  final List<BcBottomNavigationBarItem> items;
  ...
  @override
  State<BcBottomNavigationBar> createState() => _BottomNavigationBarState();
}

// This represents a single tile in the bottom navigation bar. It is intended
// to go into a flex container.
class _BottomNavigationTile extends StatelessWidget with UIAdapter {
  ...
  final BottomNavigationBarType type;
  final BcBottomNavigationBarItem item;
...
class _BottomNavigationBarState extends State<BcBottomNavigationBar>
  ...
  @override
  void didUpdateWidget(BcBottomNavigationBar oldWidget) {
