...
import 'package:flutter_module/module/main/app_root_page.dart';
import 'package:flutter_module/module/about_us/page/about_us_page.dart';
...
//
//
//     'cms/cms_page': (settings, uniqueId) {
//       return CupertinoPageRoute(
//         settings: settings,
//         builder: (_) => CMSPage(),
//       );
//     },
//     'user/about_us_page': (settings, uniqueId) {
//       return CupertinoPageRoute(
//         settings: settings,
